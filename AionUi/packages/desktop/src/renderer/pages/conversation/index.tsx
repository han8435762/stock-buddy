...
const ChatConversationIndex: React.FC = () => {
  ...
  // The root migration updates this conversation directly in the backend DB;
  // refresh the route cache so runtime workspace checks use the migrated path.
  useEffect(() => ipcBridge.stockbuddy?.rootDirChanged?.on(() => void mutate()), [mutate]);
