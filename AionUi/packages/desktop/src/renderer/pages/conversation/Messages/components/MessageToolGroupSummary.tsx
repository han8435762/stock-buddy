      ...
      <div className='flex flex-row color-#86909C gap-12px items-center'>
        ...
        <span
          className={
            ...
            (hasDetail ? ' cursor-pointer hover:text-primary-6' : '')
          }
        ...
        {hasDetail && (
          <span className='flex-shrink-0 cursor-pointer hover:text-primary-6 transition-colors' onClick={toggleExpanded}>
