...
import { Cat, Communication, Computer, Earth, Info, Puzzle, Speed, System } from '@icon-park/react';
 ...
 * stockbuddy: Model moved to the primary nav, so it is dropped here. "Agents"
 * and "Remote" (webui) are hidden as well. Their map entries below stay defined
 * and their routes remain reachable by direct URL, so re-enabling is a one-line
 * change.
 */
export const BUILTIN_TAB_IDS = ['appearance', 'pet', 'system', 'about'] as const;
