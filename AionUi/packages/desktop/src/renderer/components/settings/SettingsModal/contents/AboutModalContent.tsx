  ...
  const linkItems: LinkItem[] = [
    {
      ...
      url: 'https://github.com/han8435762/stock-buddy#readme',
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.updateLog'),
      url: 'https://github.com/han8435762/stock-buddy/releases',
      icon: <Right theme='outline' size='16' />,
    },
    {
    ...
    },
    {
      ...
      url: 'https://github.com/han8435762/stock-buddy',
      icon: <Right theme='outline' size='16' />,
    },
  ];
          ...
          <div className='flex flex-col items-center pb-24px'>
            ...
            <div className='flex items-center justify-center gap-8px mb-16px'>
              ...
              <div
                ...
                onClick={() =>
                  openLink('https://github.com/han8435762/stock-buddy').catch((error) =>
