...
import stockBuddyLogo from '@renderer/assets/logos/brand/app.png';
...
const Layout: React.FC<{
  ...
  // The "StockBuddy" wordmark acts as Home / Back-to-Chat, but only from settings routes.
            ...
            >
              ...
              >
                <div
                  ...
                  onClick={onClick}
                >
                  <img src={stockBuddyLogo} alt='StockBuddy' className='size-full object-cover block' />
                </div>
                {isSettingsRoute ? (
                  ...
                  <div className='text-16px text-t-primary collapsed-hidden font-semibold'>StockBuddy</div>
                )}
                {isMobile && !collapsed && (
                  <button
                    type='button'
