...
export interface ElectronBridgeAPI {
  ...
  // Save renderer-generated bytes without routing Unicode filenames through a data URL.
  saveDownload?: (payload: { data: Uint8Array; fileName: string }) => Promise<boolean>;
