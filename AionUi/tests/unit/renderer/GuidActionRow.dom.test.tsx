...
describe('GuidActionRow skill/MCP submenu search', () => {
  ...
  it('marks inline capabilities as compact controls in company research', () => {
    renderActionRow({ inlineCapabilities: true });

    expect(screen.getByTestId('guid-inline-skills').className).toContain('guidCompactControl');
    expect(screen.getByTestId('guid-inline-mcp').className).toContain('guidCompactControl');
  });
  ...
  it('moves skills and MCP into standalone controls for company research', () => {
    renderActionRow({ inlineCapabilities: true });

    expect(screen.getByTestId('guid-inline-skills')).toHaveTextContent('settings.capabilitiesTab.skills');
    expect(screen.getByTestId('guid-inline-mcp')).toHaveTextContent('mcp.label');
