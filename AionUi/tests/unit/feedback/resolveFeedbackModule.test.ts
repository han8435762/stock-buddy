...
describe('resolveFeedbackModule', () => {
  ...
  it('every navigable router page resolves to a module or is a known module-less page', () => {
    ...
    for (const routePath of paths) {
      ...
      // StockBuddy product pages have no dedicated feedback module; the user
      // picks the module themselves, same as the home/login surfaces.
      if (moduleLess.has(concrete) || concrete.startsWith('/stockbuddy/')) continue;
